...
import { Avatar, cn } from "@rookhub/ui";
...
import {
  ...
  useAppearanceStore,
  type ThemeChoice,
} from "@/features/appearance/store";
          ...
          <DropdownMenu.Root>
            ...
            <DropdownMenu.Portal>
              ...
              >
                ...
                {/*
                 * Portal e cobrança são do dono (RF-003): ele é quem escolhe entre
                 * IA e gestão, e quem assina o contrato. Sem a porta de volta ao
                 * portal ele ficaria preso no painel até deslogar.
                 */}
                {isOwner ? (
                  <>
                    ...
                    <DropdownMenu.Item asChild>
                      <Link to="/app/cobranca" className={itemClass}>
                    ...
                    <DropdownMenu.Item asChild>
                      <Link to="/app/extensoes" className={itemClass}>
                ...
                <DropdownMenu.Item asChild>
                  <Link to="/app/configuracoes" className={itemClass}>

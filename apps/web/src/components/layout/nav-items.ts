import type { Module, Role } from "@rookhub/types";
...
const OPERATIONAL_NAV: NavEntry[] = [
  { to: "/app", label: "Visão geral", hint: "Resumo do hub", end: true },
  {
    label: "Operação",
    items: [
      { to: "/app/mapa", label: "Mapa ao vivo", hint: "Onde a frota está agora", module: "FLEET" },
      {
        to: "/app/viagens",
        label: "Viagens",
  ...
  },
  {
    label: "Pessoas",
    items: [
      { to: "/app/motoristas", label: "Motoristas", hint: "Ficha, score e advertências" },
      {
        to: "/app/seguranca",
        label: "Segurança",
  ...
  { to: "/app/custos", label: "Custos", hint: "Custo por km em camadas", module: "COSTS" },
  { to: "/app/relatorios", label: "Relatórios", hint: "Exportações e agendamentos" },
];
...
const OWNER_NAV: NavEntry[] = [
  { to: "/app", label: "Visão geral", hint: "Resultado e resumo analítico", end: true },
  {
    to: "/app/resultado",
    label: "Resultado",
  ...
  { to: "/app/equipe", label: "Equipe", hint: "Quem trabalha na operação" },
  {
    to: "/app/aprovacoes",
    label: "Aprovações",
...
const MANAGER_NAV: NavEntry[] = [
  { to: "/app", label: "Visão geral", hint: "Prontidão e desempenho operacional", end: true },
  {
    label: "Operação",
    items: [
      { to: "/app/mapa", label: "Mapa ao vivo", hint: "Onde a frota está agora", module: "FLEET" },
  ...
  },
  {
    label: "Pessoas",
    items: [
      { to: "/app/equipe", label: "Equipe", hint: "Quadro completo e quem pode rodar hoje" },
      { to: "/app/motoristas", label: "Motoristas", hint: "Ficha, score e advertências" },
      {
        to: "/app/seguranca",
        label: "Segurança",
  ...
  { to: "/app/liberacoes", label: "Liberações", hint: "Autorizar saída de caminhão e motorista" },
  {
    label: "Análise",
    items: [
      { to: "/app/pareceres", label: "Pareceres", hint: "Explicar anomalias antes de subirem" },
      { to: "/app/custos", label: "Custos", hint: "Custo por km em camadas", module: "COSTS" },
      { to: "/app/relatorios", label: "Relatórios", hint: "Exportações e agendamentos" },
    ],
  },
...
const OPERATOR_NAV: NavEntry[] = [
  { to: "/app", label: "Visão geral", hint: "Pátio, filas e lançamentos do dia", end: true },
  { to: "/app/lancamentos", label: "Lançamentos", hint: "Abastecimento, multa, ordem e despesa" },
  {
    to: "/app/triagem",
    label: "Triagem",

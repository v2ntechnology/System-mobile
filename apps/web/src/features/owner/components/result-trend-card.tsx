import type { ResultPoint } from "@rookhub/types";
import { LightCard } from "@rookhub/ui";
...
import { ChartLegend, ChartTooltipShell, ChartViewToggle } from "@/components/charts/chart-frame";

import { brlCompact, brlWhole } from "@/lib/format";

...
import type { AnalyticsPeriod, RankingPeriod } from "@rookhub/types";
...
import { brl, brlWhole, percent } from "@/lib/format";
          ...
          {best && worst ? (
            <div className="grid gap-5 sm:grid-cols-2">
              <GlassCard className="flex min-w-0 flex-col p-5 sm:p-6">
                ...
                <p className="tabular font-display text-on-surface mt-2 text-[32px] font-bold leading-none">
                  {best.plate}
                </p>

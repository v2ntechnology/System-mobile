import type { ExpenseCategory, Vehicle, VehicleCostRank, VehicleDetail } from "@rookhub/types";

import { mockFleetExpenses, mockVehicleDetail, mockVehicles } from "@/mocks/trucks";

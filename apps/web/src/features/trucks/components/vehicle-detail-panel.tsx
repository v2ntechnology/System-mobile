...
import type { Vehicle, VehicleDetail } from "@rookhub/types";
import { Spinner, StatusChip, cn } from "@rookhub/ui";
...
function Metric({
  ...
  return (
    <div className="bg-white/4 min-w-0 rounded-md p-3">
      ...
      <p className="tabular text-on-surface text-headline-md font-display mt-1.5 font-semibold">
        {value}
      </p>
      {hint ? (

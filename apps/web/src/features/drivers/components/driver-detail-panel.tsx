...
import type { Driver, DriverWarning, WarningSeverity } from "@rookhub/types";
import { Avatar, Spinner, StatusChip, cn, type StatusTone } from "@rookhub/ui";
    ...
    >
      <header className="border-outline-variant flex flex-wrap items-start gap-4 border-b pb-5">
        ...
        <div className="min-w-0 flex-1">
          <h3 className="font-display text-on-surface text-headline-md font-bold">{driver.name}</h3>
        ...
        <div className="text-right">
          <p className="tabular font-display text-on-surface text-headline-md font-bold">
            {driver.score}
          </p>
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-4">
            {[
              ...
              <div key={metric.label} className="bg-white/4 min-w-0 rounded-md p-3">
                ...
                <p className="tabular font-display text-on-surface text-headline-md mt-1 font-semibold">
                  {metric.value}
                </p>
              </div>
            ))}

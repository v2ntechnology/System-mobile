...
export const entryFormSchema = z.object({
  ...
  liters: z.string().default(""),
  pricePerLiter: z.string().default(""),
  odometer: z.string().default(""),
  infraction: z.string().default(""),
  amount: z.string().default(""),
  dueDate: z.string().default(""),
  serviceType: z.string().default("PREVENTIVA"),
  service: z.string().default(""),
  workshop: z.string().default(""),
  estimatedCost: z.string().default(""),
  category: z.string().default("PEDAGIO"),

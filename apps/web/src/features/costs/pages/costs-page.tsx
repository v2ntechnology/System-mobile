...
import type { AnalyticsPeriod, FuelingRecord, VehicleCostRow } from "@rookhub/types";
import { DataTable, GlassCard, LightCard, StatusChip, cn, type Column } from "@rookhub/ui";
import { useQuery } from "@tanstack/react-query";
import { useState } from "react";

import { CostLayersCard } from "@/components/charts/cost-layers-card";
import { PageBanner } from "@/components/layout/page-banner";
import { PageContent } from "@/components/layout/page-content";
import { PageTabs } from "@/components/layout/page-tabs";
import { PERIOD_LABELS } from "@/components/layout/period-labels";
        ...
        <main className="mx-auto w-full max-w-2xl px-4 pb-24 sm:px-6">
          <GlassCard className="flex flex-col items-center gap-4 p-10 text-center">
            <LockSimpleIcon
              ...
              aria-hidden="true"
            />
            <h2 className="font-display text-on-surface text-headline-md">
                ...
                <GlassCard className="grid gap-4 p-5 sm:grid-cols-2 sm:p-6 xl:grid-cols-4">
                  {[
                    ...
                    <div key={layer.label} className="bg-surface-lowest min-w-0 rounded-lg p-4">
                      ...
                      <p className="tabular font-display text-on-surface mt-2 text-[24px] font-bold leading-none">

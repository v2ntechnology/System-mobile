...
import type { ReportDefinition, ReportFormat, AnalyticsPeriod } from "@rookhub/types";
import { Spinner, StatusChip } from "@rookhub/ui";
    ...
    >
      <header className="border-outline-variant flex flex-wrap items-start justify-between gap-3 border-b pb-4">
        <div className="min-w-0">
          <h3 className="font-display text-on-surface text-headline-md font-bold">
            {report.title}
          </h3>

...
import type { ReportRunStatus } from "@rookhub/types";
import { Spinner, StatusChip, type StatusTone } from "@rookhub/ui";
...
export function ReportHistory() {
  ...
  return (
    <div>
      <div className="mb-4">
        <h2 className="font-display text-primary text-headline-md">Gerações recentes</h2>

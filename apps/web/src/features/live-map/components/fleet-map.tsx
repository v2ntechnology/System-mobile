import type { VehiclePosition, VehicleStatus } from "@rookhub/types";
...
/**
 * O MapLibre monta o worker com um `new URL(...)` que o Vite não consegue
 * analisar estaticamente — o arquivo não era emitido no build e o worker dava
 * 404. Sem worker, o mapa nunca dispara `load` e a tela fica preta, sem erro
 * visível. Apontar para a URL que o próprio Vite empacota resolve.
 */

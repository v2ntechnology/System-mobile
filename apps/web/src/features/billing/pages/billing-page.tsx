...
import type { Invoice, InvoiceStatus, PlanQuota, Subscription } from "@rookhub/types";
import {
  DataTable,
  GlassCard,
  LightCard,
...
import { brl, brlWhole, dateOnly, percent } from "@/lib/format";
          ...
          {data ? (
            <div className="grid gap-5 xl:grid-cols-[1fr_1.55fr]">
              <GlassCard className="flex min-w-0 flex-col p-5 sm:p-6">
                ...
                <p className="font-display text-on-surface mt-2 text-[32px] font-bold leading-none">
                  {data.planName}
                </p>
              ...
              <GlassCard className="grid min-w-0 gap-4 p-5 sm:grid-cols-3 sm:p-6">
                ...
                <div className="bg-surface-lowest min-w-0 rounded-lg p-4">
                  ...
                  <p className="font-display text-on-surface mt-2 text-[24px] font-bold leading-none">

...
import type { ServiceOrder, ServiceOrderStatus } from "@rookhub/types";
import { GlassCard, LightCard, StatusChip, cn, type StatusTone } from "@rookhub/ui";
          ...
          <GlassCard className="grid gap-4 p-5 sm:grid-cols-2 sm:p-6 xl:grid-cols-4">
            {[
              ...
              <div key={metric.label} className="bg-surface-lowest min-w-0 rounded-lg p-4">
                ...
                <p
                  className={cn(
                    "tabular font-display mt-2 text-[28px] font-bold leading-none",
                  ...
                  <div className="grid gap-6 xl:grid-cols-[minmax(0,340px)_1fr]">
                    <div className="min-w-0">
                      <div className="mb-3 flex items-baseline justify-between gap-3">
                        <h2 className="font-display text-primary text-headline-md">Ordens</h2>
                      ...
                      {selected ? (
                        ...
                        >
                          <header className="border-outline-variant flex flex-wrap items-start justify-between gap-3 border-b pb-4">
                            <div className="min-w-0">
                              <h3 className="tabular font-display text-on-surface text-headline-md font-bold">
                                {selected.code}
                              </h3>
                          ...
                          <div className="mt-6">
                            ...
                            <p className="border-outline-variant mt-3 flex items-center justify-between gap-3 border-t pt-3">
                              ...
                              <span className="tabular font-display text-on-surface text-headline-md font-bold">

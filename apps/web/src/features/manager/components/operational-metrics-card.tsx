...
import type { OperationalMetric } from "@rookhub/types";
import { LightCard, cn } from "@rookhub/ui";
          ...
          return (
            <li key={metric.id} className="bg-light-container min-w-0 rounded-lg p-4">
              ...
              <p className="mt-2 flex items-baseline gap-2">
                <span className="tabular font-display text-on-light text-[28px] font-bold leading-none">

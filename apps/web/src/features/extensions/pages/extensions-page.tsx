...
import type { Extension, ExtensionCategory } from "@rookhub/types";
import { GlassCard, LightCard, cn } from "@rookhub/ui";
        ...
        >
          <QueryState isPending={isPending} isError={isError} label="as extensões">
            <div className="grid gap-6 pb-4 xl:grid-cols-[minmax(0,380px)_1fr]">
              ...
              <div className="min-w-0">
                {selected ? (
                  <ExtensionDetailPanel extension={selected} billableVehicles={billableVehicles} />
                ) : (

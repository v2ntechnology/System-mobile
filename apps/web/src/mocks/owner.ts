...
function buildInsights(
  ...
  insights.push(
    current.netResult >= 0
      ? {
          ...
          source,
          action: { label: "Abrir a DRE", to: "/app/resultado" },
        }
      : {
          id: "resultado",
          tone: "PERDA",
  ...
  if (improved && previous) {
    ...
    insights.push({
      ...
      impact: saved,
      source,
      action: { label: "Ver custos por categoria", to: "/app/resultado" },
    });
  }
  ...
  if (worsened && previous) {
    ...
    insights.push({
      ...
      impact: -lost,
      source,
      action: { label: "Cobrar parecer do gestor", to: "/app/aprovacoes" },
    });
  }
  ...
  if (fines) {
    insights.push({
      ...
      impact: -fines.value,
      source,
      action: { label: "Ver desempenho dos motoristas", to: "/app/desempenho" },
    });
  }

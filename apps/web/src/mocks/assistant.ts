...
const INTENTS: {
...
}[] = [
  {
    ...
    build: () => ({
      ...
      actions: [
        { label: "Ver todos os caminhões", to: "/app/caminhoes" },
        { label: "Abrir relatório de custos", to: "/app/relatorios" },
      ],
  ...
  },
  {
    ...
    build: () => ({
      ...
      actions: [
        { label: "Ver motoristas", to: "/app/motoristas" },
        { label: "Ver eventos críticos", to: "/app/relatorios" },
      ],
  ...
  },
  {
    ...
    build: () => ({
      ...
      actions: [{ label: "Ver caminhões em manutenção", to: "/app/caminhoes" }],
  ...
  },
  {
    ...
    build: () => ({
      ...
      actions: [{ label: "Ver caminhões", to: "/app/caminhoes" }],
...
export async function mockAsk(question: string): Promise<AssistantAnswer> {
  ...
  if (!intent) {
    ...
    return {
      ...
      actions: [{ label: "Ver painel", to: "/app" }],
    };
  }
